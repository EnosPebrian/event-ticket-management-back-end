  ...
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert(`events`, [
      ...
      },
      {
        ...
        time_end: "21:30:00",
        description:
          "CARASEL (Cipta Karya Seni Enam Lapan) merupakan sebuah pentas seni yang diselenggarakan oleh SMAN 68 Jakarta. Pentas seni tahun ini bertajuk CARASEL CELESTIA dengan mengangkat sebuah Cҽɾιƚα Lҽʅαɳα Sυαɾα Eυϝσɾια. Sama seperti tahun sebelumnya, 𝐂𝐀𝐑𝐀𝐒𝐄𝐋 𝐂𝐄𝐋𝐄𝐒𝐓𝐈𝐀 akan diramaikan oleh berbagai penampilan dari murid SMA 68 Jakarta hingga para 𝒈𝒖𝒆𝒔𝒕 𝒔𝒕𝒂𝒓 yang selalu meriah dengan suaranya yang membawa kegembiraan kepada Punggawan. 𝐂𝐀𝐑𝐀𝐒𝐄𝐋 𝐂𝐄𝐋𝐄𝐒𝐓𝐈𝐀 akan hadir pada tanggal 𝟮𝟭 𝗢𝗸𝘁𝗼𝗯𝗲𝗿 𝟮𝟬𝟮𝟯 𝗝𝗜𝗘𝗫𝗣𝗢 𝗚𝗮𝗺𝗯𝗶𝗿 𝗞𝗲𝗺𝗮𝘆𝗼𝗿𝗮𝗻.",
